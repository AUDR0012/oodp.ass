		...
		do {
			...
			if (user instanceof Admin) {
				do {
								...
								case 2: { // Update Course Group
									do {
										...
										case 1: { // Add Group
											...
											choice1 = Formatter.getIntegerInput("Enter Number of Sessions: ");
											for (int i = 0; i < choice1; i++) {
												group1.getSessions().add(addSession(group1, group1.getIndexNo()));
											}
											course.addGroup(group1);
					...
					case 5: { // Check Available Slot for an Index Number
					...
					case 7: { // Print Student List of Course
						found = false;
						System.out.print("Enter Course Id: ");
						in_string = in.next();
				...
				do {
					...
					case 5: { // Change Index Number of Group
