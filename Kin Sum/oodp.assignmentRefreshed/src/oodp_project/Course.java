...
public class Course implements Serializable
{
	...
	public void printCourse(String gr, int length, String delimiter, String matricNumber, String status)
	{
		System.out.print(delimiter + Formatter.tabs(length * 2, delimiter, this.getId())
				...
				+ Formatter.tabs(length * 2, delimiter, this.getType()) + Formatter.tabs(length * 1, delimiter, gr)
				+ Formatter.tabs(length * 3, delimiter, status));
	}

	public void printGroups(int gr1, int gr2, int length, String delimiter)
	{
